...
import AlertModal, { AlertModalRef } from "@/components/common/AlertModal.tsx";
...
function DeleteEquipmentAlertModal(
  { equipmentId, className }: DangerAlertModalProps,
  ...
  async function handleDeleteEquipment() {
    ...
    await ADMIN_API.delete(`/equipments/${equipmentId}/delete`, {
      ...
      .then((response: AxiosResponse<Response>) => {
        ...
        showAlert(
          response?.data.message ?? "Successfully added a equipment",
          "success"
        );
      })
    ...
    >
      <div className="w-full py-3 flex justify-center flex-col">
        <div className="flex w-full gap-2 items-center-center flex-col">
          ...
          <h1 className="text-xl text-black font-semibold mx-auto">Notice!</h1>
        </div>
